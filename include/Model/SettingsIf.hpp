...
public:
    ...
    virtual void setGenerator1Frequency(const unsigned long frequency) = 0;
    /// @brief Gets from storage generator 1 frequency
    virtual unsigned long getGenerator1Frequency() const = 0;
    ...
    virtual void setGenerator2Frequency(const unsigned long frequency) = 0;
    /// @brief Gets  from storage generator 2 frequency
    virtual unsigned long getGenerator2Frequency() const = 0;
